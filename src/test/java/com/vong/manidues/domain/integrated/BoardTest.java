...
import com.vong.manidues.domain.board.dto.BoardRegisterResponse;
...
public class BoardTest extends SpringBootTestBase {
    ...
    class IntegratedBoardTest {
        ...
        public void testViewCountAffectUpdateDate() {
            ...
            final var request = buildGetRequest(uri);
...
//            final var request = buildPostRequest(headers, body, "/api/v1/board");
    ...
    class BoardCookieTest {
        ...
        public void canSetCookie() {
            ...
            final var firstRequest = buildGetRequest(firstRequestHeaders, firstRequestUri);
            ...
            final var secondRequest = buildGetRequest(secondRequestHeaders, secondRequestUri);
